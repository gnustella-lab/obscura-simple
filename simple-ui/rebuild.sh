...
OBSCURA_VERSION="${OBSCURA_VERSION:-v1.177-14}" OBSCURA_GRESOURCES_DIR=/tmp/obscura-gresources cargo build --manifest-path "$SCRIPT_DIR/rustlib/Cargo.toml" --features gui --bin obscura-gui
